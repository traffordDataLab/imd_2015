                ...
                fluidRow(
                  tabsetPanel(
                    ...
                    tabPanel("About",
                             ...
                             tags$h4("Sources"),
                             "IMD data: ", tags$a(href="https://www.gov.uk/government/statistics/english-indices-of-deprivation-2015", "MHCLG,2015", target="_blank"),
                             tags$br(),         
                             "Boundary layers: ", tags$a(href="http://geoportal.statistics.gov.uk/", "ONS Open Geography Portal", target="_blank"),
                             tags$br(),
                             "Source code ", tags$a(href="https://github.com/traffordDataLab/imd_2015", "available on GitHub", target="_blank"),
                             tags$br(),
                             tags$h4("Credits"),
